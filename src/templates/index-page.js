  ...
  query HomeQuery($id: String!) {
    markdownRemark(id: { eq: $id }) {
      ...
      frontmatter {
        ...
        featuredImage {
          childImageSharp {
            gatsbyImageData(layout: CONSTRAINED, width: 585, height: 439, formats: [AVIF, WEBP, AUTO])
          }
        }
        cta {
          ctaText
      ...
      edges {
        node {
          ...
          frontmatter {
            ...
            featuredImage {
              childImageSharp {
                gatsbyImageData(layout: CONSTRAINED, width: 345, height: 260, formats: [AVIF, WEBP, AUTO])
              }
            }
          }
        }
